...
OBJ = yess.o Loader.o Memory.o ConditionCodes.o RegisterFile.o Tools.o FetchStage.o \
DecodeStage.o ExecuteStage.o MemoryStage.o WritebackStage.o Simulate.o PipeReg.o PipeRegField.o F.o D.o E.o M.o W.o 
